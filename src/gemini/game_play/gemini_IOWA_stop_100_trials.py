...
filepath = "gemini_igt_stop_100_trials.csv"

# -----------------------------
# ENV
# -----------------------------
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY7")
...
async def run_sessions(
    ...
    with open(output_csv, "a", newline="") as f:
        ...
        await asyncio.gather(*tasks)  # runs all 50, but semaphore caps it at 10 at once
